...
public class MergeKSortedListsTests {
    ...
    public void basicTest() {
        ...
        ListNode head1 = Utils.createLinkedList(1, 2, 3);
        ListNode head2 = Utils.createLinkedList(7, 8, 9);
        ListNode head3 = Utils.createLinkedList(4,6,11);
        ...
        head1 = Utils.createLinkedList(1,3,5,7,9);
        head2 = Utils.createLinkedList(2,4,6,8);
        head3 = Utils.createLinkedList(-1, 10);
