...
public class MergeTwoSortedListsTests {
    ...
    public void basicTest(){
        ...
        ListNode l1 = Utils.createLinkedList(new int[]{0, 0});
        ListNode l2 = Utils.createLinkedList(new int[]{1,2,3});

        ListNode result = solution.mergeTwoLists(l1, l2);
        assertEquals("0 0 1 2 3", Utils.linkedListToString(result));

         l1 = Utils.createLinkedList(new int[]{1,4,8,9});
         l2 = Utils.createLinkedList(new int[]{2,3,8});
